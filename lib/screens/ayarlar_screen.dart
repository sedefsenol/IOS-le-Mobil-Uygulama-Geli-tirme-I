...
import 'package:cinescope/screens/guvenlik_screen.dart';
...
class AyarlarlarScreen extends StatefulWidget {
  const AyarlarlarScreen({super.key});

  @override
  State<AyarlarlarScreen> createState() => _AyarlarlarScreenState();
}

class _AyarlarlarScreenState extends State<AyarlarlarScreen> {
                  ...
                  _buildRoundedButton(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const GuvenlikScreen(),
                        ),
                      );
                    },
                  ),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            // Sadece seçili olan beyaz, diğerleri gri
